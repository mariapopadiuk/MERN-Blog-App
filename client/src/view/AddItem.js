...
export default function AddItem() {
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .post("http://localhost:4000/posts/add-post", formValue, { headers })
  ...
  return (
    <>
      ...
      <div className="container mx-auto font-serif bg-additem text-5xl font-bold text-green tracking-normal text-center h-screen">
        <div className="container p-20">Add New Blog</div>
        ...
        <div className="container mx-auto max-w-sm text-3xl text-left ">
          <form>
            <div className=" form-group mb-6 ">
              <label
                htmlFor="text"
                className="text-left form-label mb-2 text-green"
              >
                Image*
              </label>
              <input
              ...
              <label className="text-left form-label mb-2 text-green">
                Title*
              </label>
              <input
                name={"title"}
            ...
            <div className="form-group mb-6">
              <label className="form-label inline-block mb-2 text-green">
                Text*
              </label>
              <textarea
                name={"text"}
            ...
            <div className="text-center">
              <button
                ...
                type="submit"
                className="px-6 py-2.5 bg-green text-white font-bold text-sm leading-tight tracking-wider uppercase rounded shadow-md hover:bg-gold hover:shadow-lg focus:bg-gold focus:shadow-lg  active:bg-gold active:shadow-lg transition duration-150 ease-in-out"
              >
                Add
              </button>
            </div>
